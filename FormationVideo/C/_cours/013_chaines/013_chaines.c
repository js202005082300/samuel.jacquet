/**
 * YouTube: https://www.youtube.com/watch?v=tDE4FNCcP0k&list=PLrSOXFDHBtfEh6PCE39HERGgbbaIHhy4j&index=13
 * Description: Langage C #13 - chaînes de caractères
 * Created: 22-02-20 | --.
 * Compiler: GNU Compiler - GCC.
 * Compilation: gcc 013_chaines.c -o prog
 ...
 */
 ...
 int main(void)
 {
    ...
    */
    ...
    motD[4] = 'e';
    motD[5] = 'l';
    motD[6] = '\n'; // ajouter la caractère '/0', caractère de fin de chaine.
    printf("%s\n",motD); 
