...
/*
	...
	Les arbres binaire:
		structure de donnees hiarchisees avec des elements, appele noeud. Le noeud initial est appele racine.
...
int main(void)
{
	...
	clean_tree(arbre_A); // Sans free(arbre), il y a une fuite de mémoire à la fin du programme. Il faudra attendre le redemarrage ou la reinitialisation de la RAM.
	...
	print_tree_prefix(arbre_C); // La racine n'est pas relié, les premiers liens sont liés en préfixe.
